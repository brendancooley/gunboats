...
```{r emp_wars, echo=FALSE, warning=FALSE, message=FALSE, fig.cap = "The modern economic peace. Data from @Marshall2002, @Barbieri2008, @Barbieri2009, @Sarkees2010, @Bolt2018. \\label{fig:emp_wars}", fig.height=8.5, dpi=750}
