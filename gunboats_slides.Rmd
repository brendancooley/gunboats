...
```{r tradeRD, echo=FALSE, warning=FALSE, message=FALSE, fig.cap = "\\label{fig:tradeRD}", fig.height=5.5, dpi=300}
...
```{r emp_wars, echo=FALSE, warning=FALSE, message=FALSE, fig.align="center", fig.height=6}
