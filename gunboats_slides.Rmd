...
```{r G1, echo=FALSE, warning=FALSE, message=FALSE, fig.height=5.5, dpi=300, cache=TRUE}
...
```{r G2, echo=FALSE, warning=FALSE, message=FALSE, fig.height=5.5, dpi=300, cache=TRUE}
...
```{r G3, echo=FALSE, warning=FALSE, message=FALSE, fig.height=5.5, dpi=300, cache=TRUE}
...
```{r iso1, echo=FALSE, warning=FALSE, message=FALSE, fig.height=5, dpi=300, cache=TRUE}
...
```{r iso2, echo=FALSE, warning=FALSE, message=FALSE, fig.height=5, dpi=300, cache=TRUE}
...
```{r tradeRD, echo=FALSE, warning=FALSE, message=FALSE, fig.cap = "\\label{fig:tradeRD}", fig.height=5.5, dpi=300, cache=T}
