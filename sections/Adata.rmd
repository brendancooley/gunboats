...
```{r comdempeace, echo=FALSE, warning=FALSE, message=FALSE, fig.cap = "Data from @Marshall2002, @Barbieri2008, @Barbieri2009, @Sarkees2010, @Bolt2018. \\label{fig:comdempeace}", fig.height=8.5, dpi=500, cache=FALSE}
