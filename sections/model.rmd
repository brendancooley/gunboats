...
**Proposition `r Peeq`:** `r PeeqText`^[These conditions are enumerated in Appendix `r AddxEconomy`.]
...
Assumption `` `r Aa` `` guarantees that the government prefers an interior tariff. This requires that the government's weight on consumer welfare be sufficiently large.
